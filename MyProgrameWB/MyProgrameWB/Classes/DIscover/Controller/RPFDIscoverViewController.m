...
@interface RPFDIscoverViewController ()

@end

@implementation RPFDIscoverViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    //创建搜索框
    RPFSearchBar *searchBar = [[RPFSearchBar alloc]initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 35)];
